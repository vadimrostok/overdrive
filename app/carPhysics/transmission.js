define([], 
    function() {
        ...
        var transmission = {
            ...
            //положении была др. заслонка во время переключения и разницы сопротивлений 
            //пропорциональной коэффициенту передачи, но кого я обманываю, система будет явно аркадной.
            engineBrake: 0,
